...
export default function Sparkline({ data, width = 220, height = 52, color = "var(--accent)", fill = true, labels }) {
  ...
  return (
    <div>
      ...
      {labels && (
        <div className="row between faint" style={{ fontSize: 9.5, marginTop: 2 }}>
